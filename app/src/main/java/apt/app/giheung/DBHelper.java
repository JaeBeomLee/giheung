...
public class DBHelper extends SQLiteOpenHelper {
	...
	public boolean checkDB(Context context){
		String filePath = "/data/data/apt.app.giheung/databases/APT14_1.db";//최신
	...
	public void dumpDB(Context mContext){
		...
		String filePath = "/data/data/apt.app.giheung/databases/APT14_1.db";//최신
		String oldfilePath = "/data/data/apt.app.giheung/databases/APT_2rd.db";//옛날
		...
		try{
			InputStream is = manager.open("db/APT14_1.db");//최신
