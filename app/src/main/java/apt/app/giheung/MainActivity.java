...
public class MainActivity extends Activity {
    ...
    private void TestTableDialog() {
        ...
        TextView t4_1 = (TextView)alt_bld.findViewById(R.id.t4_1);
        TextView t4_2 = (TextView)alt_bld.findViewById(R.id.t4_2);
        TextView t4_3 = (TextView)alt_bld.findViewById(R.id.t4_3);


        if(Integer.parseInt(ban2.substring(0,1))==1){   //1학년
            t1_1.setText("생활과 윤리");
            t1_2.setText("자습");
            t1_3.setText("음악/미술");
            ...
            t4_1.setText("운동과 건강생활");
            t4_2.setText("수학 1");

            t2_3.setText("");
            t4_3.setText("");
        }else if(Integer.parseInt(ban2.substring(0,1))==2){ //2학년
        ...
        }else if(Integer.parseInt(ban2.substring(0,1))==3){ //3학년
            if(Integer.parseInt(ban2.substring(2, 3))==1
                    ||Integer.parseInt(ban2.substring(2, 3))==2
